...
class ApiEndpointDocumentation
{
    ...
    #[OA\Post(path: '/api/condominiums/{condominium}/common-area-reservations', operationId: 'commonAreaReservationsStore', summary: 'Crear reserva de área común', tags: ['Operación diaria'], security: [['bearerAuth' => []]], requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['common_area_id', 'unit_id', 'starts_at', 'ends_at'], properties: [new OA\Property(property: 'common_area_id', type: 'integer', example: 1), new OA\Property(property: 'unit_id', type: 'integer', example: 1), new OA\Property(property: 'starts_at', type: 'string', format: 'date-time', example: '2026-06-25 18:00:00'), new OA\Property(property: 'ends_at', type: 'string', format: 'date-time', example: '2026-06-25 21:00:00'), new OA\Property(property: 'attendees_count', type: 'integer', nullable: true, example: 12), new OA\Property(property: 'notes', type: 'string', nullable: true, example: 'Reunión familiar')], type: 'object')), responses: [new OA\Response(response: 201, description: 'Reserva creada'), new OA\Response(response: 422, description: 'Datos inválidos')])]
