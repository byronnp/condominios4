...
class BankAccountMovementController extends Controller
{
    ...
    {
        return ApiResponse::success(BankAccountMovement::where('condominium_id', $condominium->id)->latest('movement_date')->get(), 'Movimientos bancarios encontrados.');
    }
    ...
    public function store(BankAccountMovementStoreRequest $request, Condominium $condominium): JsonResponse
    {
        ...
        return ApiResponse::success($movement, 'Movimiento bancario registrado correctamente.', 201);
    }
}
